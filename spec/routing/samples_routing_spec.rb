...
describe SamplesController do
  describe "routing" do
    ...
    it "routes to #index" do
      get("/indices/1/samples").should route_to("samples#index", index_id: '1')
    end

    it "routes to #new" do
      get("/indices/1/samples/new").should route_to("samples#new", index_id: '1')
    end
    ...
    it "routes to #create" do
      post("/indices/1/samples").should route_to("samples#create", index_id: '1')
    end
